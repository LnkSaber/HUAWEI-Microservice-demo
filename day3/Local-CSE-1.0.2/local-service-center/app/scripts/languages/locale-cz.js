...
angular.module('serviceCenter')
    .constant('chinese', {
        ...
        "updated": "更新",
        "footerValue": "华为软件技术有限公司 2018 保留一切权利",
        "copyright": "版权所有",
        "language": "语言",
        "testSchema": "测试契约",
        ...
        "faq": {
            "title": "常见问题",
            "whyRegisterFailed": "为什么微服务注册失败",
            "howECS": "如何在ECS上部署微服务",
            "howContainer": "如何基于容器部署微服务"
        },
        "openSource": {
            "title": "开源框架支持",
            "serviceComb": "ServiceComb开发的微服务对接公有云",
            "dubboToCSE": "Dubbo使用mesher接入CSE",
            "springCloudToCSE": "Spring Cloud应用接入CSE"
        },
        "viewMoreInfo": "查看更多信息",
        "more": "更多"
    });